...
sudo bash -c 'echo schedutil > /sys/devices/system/cpu/cpufreq/policy6/scaling_governor'
sudo bash -c 'echo dmc_ondemand > /sys/class/devfreq/dmc/governor'
sudo bash -c 'echo 20 > /sys/devices/platform/dmc/devfreq/dmc/upthreshold'